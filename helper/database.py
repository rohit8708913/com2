...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @rohit_1888" -metadata author="@Javpostr" -metadata:s:s title="Subtitled By :- @Javpostr" -metadata:s:a title="By :- @Javpostr" -metadata:s:v title="By:- @rohit_1888" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
