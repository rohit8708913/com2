...
-vf "scale='if(gt(iw,ih),1920,-1)':'if(gt(iw,ih),-1,1080)',subtitles={subtitle_file_path},drawtext=text='by @Javpostr':fontcolor=white@0.8:fontsize=48:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf:x=10:y=h-th-10" \
